...
unclustered_fasta = "/data/unclustered.fa"
##################################################################################################################################################################
...
prepare_fasta_database(unclustered_fasta, fasta_dir+famid_name, outPath+famid_name+"_db.fa")
###################################################################################################################################################################

execute_phmmer_familyfasta_vs_masterfasta(outPath+"/"+famid_name+".phmmertlbout", fasta_dir+famid_name, outPath+famid_name+"_db.fa")
###################################################################################################################################################################

get_sequences_from_phmmer_search(outPath+"/"+famid_name+".phmmertlbout",fasta_dir+famid_name, outPath+"/"+famid_name+".seqlist")
###################################################################################################################################################################

get_fasta_from_sequence_list(outPath+"/"+famid_name+".seqlist", outPath+famid_name+"_db.fa", outPath+"/"+famid_name+"_closest_sequences.fa")
###################################################################################################################################################################
